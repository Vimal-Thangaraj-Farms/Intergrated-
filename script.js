...
const products = [
  ...
  { id: 7, name: 'அத்திப்பழம் (Aathi Palam / Fig)', category: 'fruits', price: 150, oldPrice: 180, weight: '1 kg', image: 'Aathi_Palam.png', badge: 'Premium', badgeType: 'Most Like', desc: 'உடல் ஆரோக்கியத்திற்கு மிகச்சிறந்த தாதுக்கள் நிறைந்த புத்தம் புதிய அத்திப்பழம்.', rating: 4.9, reviews: 640 },
  { id: 8, name: 'பன்னீர் ஆப்பிள் (Water Apple)', category: 'fruits', price: 50, oldPrice: 80, weight: '1 kg', image: 'Water_Apple.png', badge: 'Natural Sweet', badgeType: 'Water Content', desc: 'எங்கள் பண்ணையில் விளைந்த இனிப்பான மற்றும் நீர்ச்சத்து நிறைந்த பன்னீர் ஆப்பிள்.', rating: 4.9, reviews: 278 }
];
